...
<section class="component-section">
    ...
    <div class="preview-box" style="max-width: 400px;">
        ...
        $demo_card->body()->append_child(new \k1lib\html\bootstrap\components\button('Go somewhere', \k1lib\html\bootstrap\components\button::VARIANT_PRIMARY));
...
<span class="text-warning">$card</span>-><span class="text-light">body</span>()-><span class="text-light">append_child</span>(
    <span class="text-info">new</span> \k1lib\html\bootstrap\components\button(<span class="text-success">'Go somewhere'</span>, \k1lib\html\bootstrap\\k1lib\html\bootstrap\components\button::<span class="text-light">VARIANT_PRIMARY</span>)
);
