...
<section class="component-section">
    ...
    <div class="component-ref">\k1lib\html\bootstrap\components\accordion &rarr; src/klan1/html/bootstrap/accordion.php</div>

    <div class="preview-label">Default (One open at a time)</div>
    <div class="preview-box">
        <?php
        $accordion = new \k1lib\html\bootstrap\components\accordion('demo-default');
    ...
    <div class="preview-box">
        <?php
        $accordion2 = new \k1lib\html\bootstrap\components\accordion('demo-default-open');
    ...
    <div class="preview-box">
        <?php
        $accordion3 = new \k1lib\html\bootstrap\components\accordion('demo-flush', \k1lib\html\bootstrap\components\accordion::MODE_DEFAULT, true);
    ...
    <div class="preview-box">
        <?php
        $accordion4 = new \k1lib\html\bootstrap\components\accordion('demo-always', \k1lib\html\bootstrap\components\accordion::MODE_ALWAYS_OPEN);
    ...
    <div class="preview-box">
        <?php
        $accordion5 = new \k1lib\html\bootstrap\components\accordion('demo-array');
...
<span class="text-warning">$accordion</span> = <span class="text-info">new</span> \k1lib\html\bootstrap\components\accordion(<span class="text-success">'demo'</span>);
...
<span class="text-warning">$accordion</span> = <span class="text-info">new</span> \k1lib\html\bootstrap\components\accordion(
    <span class="text-success">'demo'</span>,
    \k1lib\html\bootstrap\components\accordion::<span class="text-light">MODE_ALWAYS_OPEN</span>
);

<span class="text-primary">// Flush variant</span>
<span class="text-warning">$accordion</span> = <span class="text-info">new</span> \k1lib\html\bootstrap\components\accordion(
    <span class="textsuccess">'demo'</span>,
    \k1lib\html\bootstrap\components\accordion::<span class="text-light">MODE_DEFAULT</span>,
