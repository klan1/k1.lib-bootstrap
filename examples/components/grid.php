...
<section class="component-section">
    ...
    <div class="component-ref">\k1lib\html\bootstrap\components\grid &rarr; src/klan1/html/bootstrap/grid.php</div>

    <div class="preview-label">Basic Grid</div>
    <div class="preview-box">
        <?php
        $demo_grid = new \k1lib\html\bootstrap\components\grid(2, 3);
    ...
    <div class="code-block">
        ...
        <pre class="code-content"><code><span class="textwarning">$grid</span> = <span class="text-info">new</span> \k1lib\html\bootstrap\components\grid(<span class="text-info">2</span>, <span class="text-info">3</span>);
