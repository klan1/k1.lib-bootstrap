...
<section class="component-section">
    ...
    <div class="component-ref">\k1lib\html\bootstrap\components\alert &rarr; src/klan1/html/bootstrap/alert.php</div>
    ...
    <div class="preview-box">
        ...
        foreach ($types as $type) {
            $a = new \k1lib\html\bootstrap\components\alert("A simple {$type} alert—check it out!", $type, true);
            echo $a->generate();
        }
        ?>
    </div>
    ...
    <div class="code-block">
        ...
        <pre class="code-content"><code><span class="text-warning">$alert</span> = <span class="text-info">new</span> \k1lib\html\bootstrap\components\alert(
