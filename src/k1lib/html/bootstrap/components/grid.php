...
class grid extends \k1lib\html\div {
     ...
     * @return \k1lib\html\bootstrap\components\grid_row|null The grid row or null if not found
     */
     ...
     * @return \k1lib\html\bootstrap\components\grid_row The newly created row
     */
